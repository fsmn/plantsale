...
<script type="text/javascript" src="<?php echo base_url("js/stickytable.js");?>"></script>
...
<!-- variety Scripts -->
<script type="text/javascript" src="<?php echo base_url("js/variety.js");?>"></script>

<!-- Order Scripts -->
<script type="text/javascript" src="<?php echo base_url("js/order.js");?>"></script>
<!-- Grower and Contact Script -->
<script type="text/javascript" src="<?php echo base_url("js/grower.js");?>"></script>
