...
$buttons["print-letter"] = array("text"=>"Print Letter","class"=>"button print variety-print-letter-one","href"=>site_url("variety/print_one/$variety->id/letter"), "target"=>"_blank");
$buttons["print-shovel_foot"] = array("text"=>"Print Shovel Foot","class"=>"button print variety-print-letter-one","href"=>site_url("variety/print_one/$variety->id/shovel_foot"), "target"=>"_blank");
