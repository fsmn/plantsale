...
// 			$this->db->select("order.plant_cost, order.pot_size, order.price,order.count_presale, order.count_midsale,order.grower_code, order.count_dead,order.crop_failure" );
// 			$this->db->select("order.")
