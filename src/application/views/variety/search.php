...
<form name="search-variety" id="search-variety" class="search-form"
	  action="<?php echo site_url("variety/search"); ?>" method="GET">
	<input type="hidden" name="find" value="1"/>
	<div class="field-set">
		<label for="action">Search Type: </label>
		<?php echo form_dropdown("action", $actions, $refine ? cookie("action") : '', "id='action'"); ?>
	</div>
	...
	<div class="field-set box standard" style="font-size: .9em">
		...
		<input type="checkbox" name="no_image"
			   id="no_image" <?php echo $refine && cookie("no_image") == 1 ? "checked" : ""; ?>
			   value="1"/>
	...
	<div class="field-set standard">
		<div class="column first">
			...
			<?php echo form_dropdown("flag", $flags, [$refine ? cookie("flag") : ''], "id='flag'"); ?>
			<br/>
			<input type="checkbox" name="not_flag" style="width: auto;" value=1
				   id="not_flag" <?php echo cookie("not_flag") ? "checked" : ""; ?>
		...
		<div class="column last">
			...
			<?php echo form_dropdown("plant_color", $plant_colors, [$refine ? cookie("plant_color") : ""], "id='plant_colors'"); ?>
		</div>
	</div>
	...
	<div class="field-set block box standard">
		...
		&nbsp;<?php echo $sunlight; ?>
		&nbsp; <?php echo form_dropdown("sunlight-boolean", [
				"and" => "and",
				"or" => "or",
				"only" => "only",
