 ...
 */
$config['site_title'] = "Friends School Plant Sale Backoffice Database";       // Site Title, example.com
$config['admin_email'] = "chris@cerebratorium.com"; // Admin Email, admin@example.com
