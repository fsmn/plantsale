				...
				<tr class="<?php echo implode(" ", $row_classes); ?>" id="order_<?php echo $order->id; ?>" title="<?php echo $row_title; ?>">
					...
					<?php if (!$show_names) : ?>
						<td tabindex=-1 class="order-year field">
							<?php echo edit_field("year", $order->year, "", "order", $order->id, array("envelope" => "span")); ?>
						</td>
					<?php endif; ?>
					<td tabindex=-1 class="order-grower_id field">
						<?php echo edit_field("grower_id", $order->grower_id, "", "order", $order->id, array("envelope" => "span")); ?>
					</td>
					...
					<?php if ($show_names) : ?>
						...
						<td>
							<a tabindex=-1 style="font-weight: bold" href="<?php echo site_url("variety/view/$order->variety_id"); ?>" title="View the details for <?php echo $order->variety; ?>"><?php echo $order->variety; ?></a>
						</td>
					<?php endif; ?>
					...
					<td class="order-pot_size field no-wrap">
						<?php echo edit_field("pot_size", $order->pot_size, "", "order", $order->id, array("envelope" => "span", "class" => "pot-size")); ?>
					</td>
					...
					<td tabindex=-1 class="order-grower_code field">
						<?php echo edit_field("grower_code", $order->grower_code, "", "order", $order->id, array("envelope" => "span")); ?>
					</td>
