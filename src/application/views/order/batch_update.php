...
<form id="batch-update" name="batch-update" method="post" action="<?php print base_url('order/batch_update'); ?>">
	...
	<div class="orders-pot_size field">
		<label for="pot_size">Pot Size:&nbsp;
			<?php print form_dropdown('pot_size', $pot_sizes); ?></label>
	</div>
	...
	<div class="orders-flat_area field">
		<label for="flat_area">Flat Area:&nbsp;
			<input type="text" name="flat_area" value="" autocomplete="off" /></label>
	</div>
	<div class="orders-tiers field">
		<label for="tiers">Tiers:&nbsp;
			<input type="text" name="tiers" value="" autocomplete="off" /></label>
	</div>
	<div class="grower-code field">
		<label for="grower_code">Grower Code:&nbsp;
			<input type="text" name="grower_code" value="" autocomplete="off" /></label>
	</div>
