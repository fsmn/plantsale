...
?>
	...
	<table class="list profitability hideable-columns">
		...
		<tbody>
			...
			?>
				<tr class="<?php print implode(' ', $row_classes); ?>" id="order_<?php print $order->id; ?>">
					<td class="no-wrap">
						<?php if (IS_ADMIN) : ?>
					...
					<td>
						<a tabindex=-1 href="<?php print site_url(sprintf('common/find?genus=%s', $order->genus)); ?>" title="View all <?php print $order->genus; ?>">
							<?php print $order->genus; ?>
						</a>
						<a tabindex=-1 href="<?php print site_url('common/view/' . $order->common_id); ?>" title="View the details for <?php print $order->name; ?>">
							<?php print $order->name; ?>
						</a>
						<a tabindex=-1 style="font-weight: bold" href="<?php print site_url('variety/view/' . $order->variety_id); ?>" title="View the details for <?php print $order->variety; ?>">
