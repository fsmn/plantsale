...
?>
<form method="post" enctype="multipart/form-data" name="variety-image-editor" id="variety-image-editor"
	  action="<?php print site_url('variety/attach_image'); ?>">
	<input type="hidden" name="variety_id" id="variety_id" value="<?php print $variety_id; ?>"/>
	<input type="hidden" name="id" id="id" value="<?php print get_value($image, 'id'); ?>"/>
