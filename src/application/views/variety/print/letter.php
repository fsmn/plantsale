				...
				<div class="image">
					...
					<ul class="flags icons">
						<?php foreach ($flags as $flag) {
							print sprintf("<li class='%s'>%s</li>", css_classify($flag->name), format_flags([$flag], 'poster'));
				...
				<div class="icons-dimensions">
					<ul class="sunlight icons">
						...
						foreach ($sunlight as $light) {
							print sprintf("<li class='%s'>%s</li>", css_classify($light), format_sunlight($light, 'poster'));
						}
						?>
					</ul>
