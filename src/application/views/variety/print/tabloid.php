...
<div class="<?php echo implode(" ",$classes);?>">
	...
	<?php endif;?>
	<span class="variety">
			<a href="<?php echo site_url("variety/view/$variety->id");?>" target="_blank"><?php echo $variety->variety;?></a>
		</span>
		...
		<div class="dimensions">
			<?php if($variety->min_height || $variety->max_height):?>
				<div class="height">
					<label>Height</label>
					<div class="text">
						<?php echo format_dimensions($variety->min_height, $variety->max_height, abbr_unit($variety->height_unit));?>
					</div>
				</div>
			<?php endif;?>
			<?php if($variety->min_width || $variety->max_width):?>
				<div class="width">
						<label>Width</label>
						<div class="text">
							<?php echo format_dimensions($variety->min_width, $variety->max_width, abbr_unit($variety->width_unit));?>
						</div>
				</div>
			<?php endif;?>
		</div>
