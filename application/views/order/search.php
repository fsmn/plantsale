...
<p><label for="category">Category: </label><input type="text" class="autocomplete-live" category="common_category" name="category" id="category" value="<?=$refine?get_cookie("category"):"";?>"/></p>
<p><label for="subcategory">Subcategory: </label><input type="text" class="autocomplete-live" category="common_subcategory" name="subcategory" id="subcategory" value="<?=$refine?get_cookie("subcategory"):"";?>"/></p>

<p><label for="genus">Genus</label>&nbsp;<input type="text" name="genus" id="genus" value="<?=$refine?get_cookie("genus"):"";?>"/></p>
...
<p><label for="flat_size">Flat Size</label>&nbsp;<input type="number" name="flat_size" style="width:3em;" value="<?=$refine?get_cookie("flat_size"):"";?>"/></p>
<p><label for="year">Year</label>&nbsp;<input type="number" name="year" style="width:4em" value="<?php echo get_cookie("sale_year");?>"/></p>
<p><label for="new_year">First Year at Sale</label>&nbsp;<input type="number" name="new_year" title "(enter current year for all new items)" style="width:4em" value="<?=$refine?get_cookie("new_year"):"";?>"/></p>
