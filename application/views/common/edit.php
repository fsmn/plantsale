...
<p><label for="category">Category: </label><input type="text" class="autocomplete-live" category="common_category" name="category" id="category" value="<?=get_value($common,'category');?>" required/></p>
