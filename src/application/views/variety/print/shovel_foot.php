...
<div class="<?php print implode(' ',$classes);?>">
	...
	<div class="common-name" <?php print $common_size;?>><?php print $variety->common_name;?></div>
	</div>
<div class="subheader">
...
<?php endif;?>
	<span class="variety"><a href="<?php print site_url('variety/view/' . $variety->id);?>" target="_blank"><?php print $variety->variety;?></a></span>
