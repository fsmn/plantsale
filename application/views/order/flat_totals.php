...
?>
<!-- order/flat-totals -->
<table class="chart table table-bordered table-condensed">
<thead>
<tr>
<td>
</td>
...
<? foreach($categories["current"] as $category) : ?>
	<tr>
	<td>
	<a href="<?=site_url("order/search?find=1&year=$sale_year&category_id=$category->category_id&sorting%5B%5D=genus&direction%5B%5D=ASC");?>"><?=$category->category;?></a>
	</td>
