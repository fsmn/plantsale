...
<?php echo create_button(array("text"=>"Hide","class"=>"button hide-quark-export small","href"=>"#"));?>
	...
	<li class="category item"><a class="export" href="<?php echo site_url("index/quark");?>">All Categories <i class='fa fa-download'></i></a></li>
...
<?php echo $subcategory->subcategory;?> <i class='fa fa-download'></i>
</a></li>
<?php endforeach; ?>
</ul>
</li>
