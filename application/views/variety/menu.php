...
$buttons["print-shovel_foot"] = array("text"=>"Print Shovel Foot","class"=>"button print variety-print-letter-one","style"=>"print","href"=>site_url("variety/print_one/$variety->id/shovel_foot"), "target"=>"_blank");
