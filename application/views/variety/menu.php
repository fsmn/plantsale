...
$buttons["print-options"] = array("text"=>"Print","class"=>"button print variety-print-options","id"=>"print-options_$variety->id","href"=>site_url("variety/print_options/$variety->id"),"selection"=>"home");
if(DB_ROLE == 1){
