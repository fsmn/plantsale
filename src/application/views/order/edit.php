...
?>
<h4><?php echo get_value($order, "variety", "Order for New Variety"); ?></h4>
...
<form name="order-edit" id="order-edit" class="no-wrap"
	...
	<div class="column first">
		...
		<div class="order-year field">
			...
			<input type="number"
				   name="year"
				   value="<?php echo get_value($order, "year", get_current_year()); ?>"
				   required/>
		</div>
		...
		<div class="order-flat_size field">
			<label for="flat_size">Flat Size:&nbsp;</label> <input
					type="text"
					name="flat_size"
		...
		<div class="order-flat_cost field">
			<label for="flat_cost">Flat Cost:&nbsp;</label> <input
					type="text"
					name="flat_cost"
		...
		<div class="order-plant_cost field">
			<label for="plant_cost">Plant Cost:&nbsp;</label> <input
					type="text"
					name="plant_cost"
			...
			<?php foreach ($days as $day): ?>
				<div class="order-count_presale field">
					...
					<input type="text"
						   ...
						   value="<?php echo get_value($order, 'count_' . $day); ?>"
						   autocomplete="off"/>
				</div>
			<?php endforeach; ?>
		...
		<div class="column last">
				...
				<div class="order-<?php print $field_name; ?> field">
					<label for="<?php print $field_name; ?>"><?php print ucfirst($day); ?>
						Received:&nbsp;</label> <input type="text"
													   ...
													   value="<?php echo get_value($order, $field_name); ?>"
													   autocomplete="off"/>
				</div>
			<?php endforeach; ?>
			<?php if (get_value($order, 'year') != 2020): ?>
				...
				<div class="order-count_dead field">
					<label for="count_dead">Dead Count:&nbsp;</label> <input
							type="text"
							name="count_dead"
